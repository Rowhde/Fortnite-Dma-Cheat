...
bool ImGui::TreeNodeBehavior(ImGuiID id, ImGuiTreeNodeFlags flags, const char* label, const char* label_end)
{
    ...
    const ImVec2 label_size = ImVec2(0.0f, 0.0f);
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
    ...
    if (selected && !hovered)
    {
        PushStyleColor(ImGuiCol_Text, ImVec4(179 / 255.0f, 138 / 255.0f, 1.0f, 1.0f)); // set text color to pink
    ...
    {
        PushStyleColor(ImGuiCol_Text, ImVec4(220 / 255.0f, 138 / 255.0f, 1.0f, 1.0f)); // set text color to pink
