...
inline std::string name = ("Add your keyauth shit"); // application name. right above the blurred text aka the secret on the licenses tab among other tabs
inline std::string ownerid = ("69"); // ownerid, found in account settings. click your profile picture on top right of dashboard and then account settings.
inline std::string secret = ("420"); // app secret, the blurred text on licenses tab and other tabs
inline std::string version = ("1.0"); // leave alone unless you've changed version on website//std::string name = "urd"; // application name. right above the blurred text aka the secret on the licenses tab among other tabs
inline std::string url = ("https://keyauth.win/api/1.2/"); // change if you're self-hosting
inline KeyAuth::api KeyAuthApp(name, ownerid, secret, version, url);